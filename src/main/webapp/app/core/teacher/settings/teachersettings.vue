            ...
            <div class="row m-0">
                ...
                <div class="col-4 pl-2 p-0 d-flex justify-content-center">
                    <div class="circle" style="width: 74px; height: 74px;">
                        <img class="p-0 w-100 h-100" style="borderRadius: 50%;" :src="teacherPhoto"/>
                    </div>
                </div>
                ...
                <div class="col-8 p-0">
                    ...
                    <div class="row m-0">
                        ...
                        <div class="col-12 p-0">
                            <p class="font-weight-regular m-0 blue text-left">{{teacherName}}</p>
                        </div>

                        <div class="col-12 p-0">
                            <p class="font-weight-regular m-0 gray text-left">{{teacherPhone}}</p>
                        </div>

                        <div class="col-12 p-0">
                            <p class="font-weight-regular m-0 gray text-left">{{teacherEmail}}</p>
                        </div>
