            ...
            <div class="row m-0">
                ...
                <div class="col-4 pl-2 p-0 d-flex justify-content-center">
                    <div class="circle" style="width: 74px; height: 74px;">
                        <img class="p-0 w-100 h-100" style="borderRadius: 50%;" src="https://www.buscabiografias.com/img/people/Francisco-M%C3%A1rquez.jpg"/>
                    </div>
                </div>
                ...
                <div class="col-8 p-0">
                    ...
                    <div class="row m-0">
                        ...
                        <div class="col-12 p-0">
                            <p class="font-weight-regular m-0 blue text-left">Felipe Santiago Xicoténcatl</p>
                        </div>

                        <div class="col-12 p-0">
                            <p class="font-weight-regular m-0 gray text-left">(844) 123-45-67</p>
                        </div>

                        <div class="col-12 p-0">
                            <p class="font-weight-regular m-0 gray text-left">felipextl@gmail.com</p>
                        </div>
            ...
            <div class="p-2 mt-2">
                <div class="container card p-2">
                    ...
                    <div class="row pt-2 p-0 m-0">
                        ...
                        <div class="col-10 p-0">
                            <p class="font-weight-regular m-0 pl-3 p-0 blue text-left">Data</p>
                        </div>
