...
@RestController
@RequestMapping("/api/ij-school-manager-gateway-kafka")
public class IjSchoolManagerGatewayKafkaResource {

    private final Logger log = LoggerFactory.getLogger(IjSchoolManagerGatewayKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public IjSchoolManagerGatewayKafkaResource(KafkaProperties kafkaProperties) {
