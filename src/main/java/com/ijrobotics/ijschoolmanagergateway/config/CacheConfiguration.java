...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("IJSchoolManagerGateway");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("IJSchoolManagerGateway");
        ...
        config.getMapConfigs().put("com.ijrobotics.ijschoolmanagergateway.domain.*", initializeDomainMapConfig(jHipsterProperties));
